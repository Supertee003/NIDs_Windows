...
pub fn build(b: *std.Build) void {
    ...
    // G10: Added pep_enforcement_proof.zig (PEP authority separation, validation, execution, deferred queue).
    //
    ...
    //   core/pep_enforcement_proof.zig -> self-contained (no runtime module imports)
    //

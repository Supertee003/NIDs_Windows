//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite Phase 11)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! Phase 11 changes (on top of Phase 10):
//!   - Added Brain Advisor to start()/shutdown() sequence.
//!   - Brain is initialized AFTER Threat Intel (it needs all enrichment signals).

...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 11: Added brain_engine.zig + brain_integration.zig.
    //
    // Import chain verification (updated for Phase 11):
    //   core/dispatcher.zig           -> + brain_integration
    //   core/lifecycle.zig           -> + brain_integration
    //   core/brain_engine.zig        -> canonical_event + flow_engine + detection_engine
    //                                    + verdict_aggregator + correlation_engine + threat_intel (all exist)
    //   core/brain_integration.zig   -> + brain_engine (exists)
    //
    ...
    const test_files = [_][]const u8{
        ...
        "core/wfp_ioctl.zig",
        // Runtime modules (Phase 5 + 6 + 7 + 8 + 9 + 10 + 11)
        "core/dispatcher.zig",
        "core/lifecycle.zig",
        ...
        // Brain Advisor modules (Phase 11 NEW)

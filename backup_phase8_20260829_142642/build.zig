...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 7: Added detection_engine.zig + detection_integration.zig.
    //
    // Import chain verification (updated for Phase 7):
    ...
    //                                    + detection_integration + forensic_log + dispatcher (local)

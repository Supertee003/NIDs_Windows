...
npcap_test_live.exe                          # 1) list devices
npcap_test_live.exe 0                        # 2) capture 20 packets on device 0
npcap_test_live.exe 0 50 "tcp port 80"       # 3) 50 packets with BPF filter
```

...
pub fn build(b: *std.Build) void {
    ...
    // G5: Added detection_fabric_proof.zig (detector contract, evidence, non-invasive detector).
    //
    ...
    //   core/detection_fabric_proof.zig -> canonical_event + flow_engine + detection_engine (all exist)
    //

//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite G5 Detection)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! G5: Added Detection Fabric Proof (detector contract, evidence aggregation, non-invasive detector).

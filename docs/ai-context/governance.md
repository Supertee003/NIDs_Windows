...
5. Gates:      zig build test, python -m pytest tests/test_golden_path.py -q,
...
| G2 Golden path | `python -m pytest tests/test_golden_path.py -q` | End-to-end pipeline health |

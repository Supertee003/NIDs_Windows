//! runtime/dispatcher.zig - AEGIS Runtime Dispatcher (Rewrite Phase 9)
//!
...
pub fn processEvent(event: canonical.CanonicalEvent) void {
    ...
    // Phase 12+: policy_int.evaluateAndEnforce(event, av, alerts)
    // Phase 14+: forensics_int.logPipelineResult(event, av, alerts)
}

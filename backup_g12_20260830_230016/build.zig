...
pub fn build(b: *std.Build) void {
    ...
    // G12: Added config_reload_proof.zig (hot reload, atomic swap, validation, version tracking).
    //
    ...
    //   core/config_reload_proof.zig -> self-contained (no runtime module imports)
    //

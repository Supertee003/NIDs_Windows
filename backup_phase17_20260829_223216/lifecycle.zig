//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite Phase 16)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! Phase 16 changes (on top of Phase 15):
//!   - Added E2E Harness to start()/shutdown() sequence.
//!   - E2E is a test framework (not a pipeline stage).

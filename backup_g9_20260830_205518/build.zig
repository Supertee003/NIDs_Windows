...
pub fn build(b: *std.Build) void {
    ...
    // G8: Added brain_proof.zig (advisory only, fail-soft, 5 capabilities, 5 forbidden actions).
    //
    ...
    //   core/brain_proof.zig -> canonical_event + detection_engine + brain_engine + verdict_aggregator (all exist)
    //

//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite Phase 14)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! Phase 14 changes (on top of Phase 13):
//!   - Added Forensics to start()/shutdown() sequence.
//!   - Forensics is the FINAL stage (records everything for replay).

...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 18: Added ips_canary.zig + ips_canary_integration.zig.
    //
    ...
    //   core/ips_canary.zig          -> canonical_event + detection_engine + policy_engine + rust_pep + forensics_engine (all exist)
    //   core/ips_canary_integration.zig -> canonical_event + forensics_engine + ips_canary (all exist)
    //

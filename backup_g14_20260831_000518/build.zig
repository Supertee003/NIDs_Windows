...
pub fn build(b: *std.Build) void {
    ...
    // G14: Added audit_trail_proof.zig (chain of custody, immutable audit log, tamper-evident).
    //
    ...
    //   core/audit_trail_proof.zig -> self-contained (no runtime module imports)
    //

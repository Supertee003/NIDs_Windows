//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite Phase 12)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! Phase 12 changes (on top of Phase 11):
//!   - Added Policy Engine to start()/shutdown() sequence.
//!   - Policy is initialized AFTER Brain (it consumes BrainAdvice).

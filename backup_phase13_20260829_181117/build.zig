...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 12: Added policy_engine.zig + policy_integration.zig.
    //
    // Import chain verification (updated for Phase 12):
    //   core/dispatcher.zig           -> + policy_integration
    //   core/lifecycle.zig           -> + policy_integration
    //   core/policy_engine.zig       -> canonical_event + flow_engine + detection_engine
    //                                    + verdict_aggregator + correlation_engine + threat_intel
    //                                    + brain_engine (all exist)
    //   core/policy_integration.zig  -> + policy_engine (exists)
    //
    ...
    const test_files = [_][]const u8{
        ...
        "core/wfp_ioctl.zig",
        // Runtime modules (Phase 5 + 6 + 7 + 8 + 9 + 10 + 11 + 12)
        "core/dispatcher.zig",
        "core/lifecycle.zig",
        ...
        // Policy Engine modules (Phase 12 NEW)

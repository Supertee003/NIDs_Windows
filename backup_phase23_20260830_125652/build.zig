...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 23: Added hids_engine.zig + hids_integration.zig.
    //
    ...
    //   core/hids_engine.zig -> canonical_event (exists)
    //   core/hids_integration.zig -> canonical_event + hids_engine (exists)
    //

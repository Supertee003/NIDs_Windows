...
test "replay integration: full lifecycle (init, compare, stats, shutdown)" {
    ...
    const orig = @import("../../forensic/forensics_engine.zig").PipelineResult{
        .event_id = 1,
        .timestamp_ns = 1000,
        ...
        .dest_port = 80,
        .protocol = 6,
        .aggregated_verdict = @import("../../detection/detection_engine.zig").Verdict.benign,
        .aggregated_confidence = 50,
        .escalated = false,
        .original_verdict = @import("../../detection/detection_engine.zig").Verdict.benign,
        ...
        .brain_recommended_verdict = @import("../../detection/detection_engine.zig").Verdict.benign,
        .policy_action = @import("../../policy/policy_engine.zig").EnforcementAction.allow,
        .policy_rule = @import("../../policy/policy_engine.zig").PolicyRule.default_allow,
        .policy_confidence = 50,
        .pep_status = @import("../../core/rust_pep.zig").EnforcementStatus.no_op,
    ...
    replayed_diff.aggregated_verdict = @import("../../detection/detection_engine.zig").Verdict.suspicious;
    replayed_diff.policy_action = @import("../../policy/policy_engine.zig").EnforcementAction.alert;

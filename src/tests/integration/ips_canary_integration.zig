...
const forensics = @import("../../forensic/forensics_engine.zig");
const canary = @import("../../windows/ips_canary.zig");
...
test "ips canary integration: full lifecycle (init, create, verify, health, shutdown)" {
    ...
    const test_def = @import("../../windows/ips_canary.zig").CANARY_TESTS[0];
    ...
    const token = @import("../../windows/ips_canary.zig").CanaryToken.unpack(canary_event.session_id);
    try std.testing.expect(token != null);
    try std.testing.expect(token.?.magic == @import("../../windows/ips_canary.zig").CANARY_MAGIC);
    ...
    const forensics_engine = @import("../../forensic/forensics_engine.zig");
    const canary_mod = @import("../../windows/ips_canary.zig");
    const record = forensics_engine.ForensicRecord{
        .result = .{
            ...
            .dest_port = 80,
            .protocol = 6,
            .aggregated_verdict = @import("../../detection/detection_engine.zig").Verdict.malicious,
            .aggregated_confidence = 90,
            .escalated = false,
            .original_verdict = @import("../../detection/detection_engine.zig").Verdict.malicious,
            ...
            .brain_recommended_verdict = @import("../../detection/detection_engine.zig").Verdict.malicious,
            .policy_action = @import("../../policy/policy_engine.zig").EnforcementAction.block,
            .policy_rule = @import("../../policy/policy_engine.zig").PolicyRule.verdict_malicious,
            .policy_confidence = 90,
            .pep_status = @import("../../core/rust_pep.zig").EnforcementStatus.executed,
            .pep_rejection_reason = @import("../../core/rust_pep.zig").RejectionReason.none,

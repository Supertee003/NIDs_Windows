...
const replay_int = @import("../tests/integration/replay_integration.zig");
const e2e_int = @import("../tests/integration/e2e_harness_integration.zig");
const perf_int = @import("../tests/integration/performance_integration.zig");
const canary_int = @import("../tests/integration/ips_canary_integration.zig");
const xdr_int = @import("../tests/integration/xdr_harden_integration.zig");
const release_int = @import("../tests/integration/release_engineering_integration.zig");
const rag_int = @import("../tests/integration/rag_integration.zig");
const hids_int = @import("../tests/integration/hids_integration.zig");
const conc_int = @import("../tests/integration/concurrency_harden_integration.zig");
const fault_int = @import("../tests/integration/fault_injection_integration.zig");
const ips_sim_int = @import("../tests/integration/ips_simulation_integration.zig");
const policy_plane_int = @import("../tests/integration/policy_plane_integration.zig");
...
pub fn start(allocator: std.mem.Allocator) !void {
    ...
    const dispatcher = @import("../policy/dispatcher.zig");

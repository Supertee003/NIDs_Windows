...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 24: Added concurrency_harden.zig + concurrency_harden_integration.zig.
    //
    ...
    //   core/concurrency_harden.zig -> std + canonical_event (exists)
    //   core/concurrency_harden_integration.zig -> concurrency_harden (exists)
    //

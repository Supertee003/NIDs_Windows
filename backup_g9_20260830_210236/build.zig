...
pub fn build(b: *std.Build) void {
    ...
    // G9: Added policy_plane_proof.zig (Policy IR stability, signing, conflict resolution).
    //
    ...
    //   core/policy_plane_proof.zig -> policy_plane (phase27, all exists) -- no canonical/detection imports
    //

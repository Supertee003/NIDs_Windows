...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 13: Added rust_pep.zig + rust_pep_integration.zig.
    //
    // Import chain verification (updated for Phase 13):
    //   core/dispatcher.zig           -> + rust_pep_integration
    //   core/lifecycle.zig           -> + rust_pep_integration
    //   core/rust_pep.zig           -> canonical_event + policy_engine (both exist)
    //   core/rust_pep_integration.zig -> canonical_event + policy_engine + rust_pep (all exist)
    //
    ...
    const test_files = [_][]const u8{
        ...
        "core/wfp_ioctl.zig",
        // Runtime modules (Phase 5 + 6 + 7 + 8 + 9 + 10 + 11 + 12 + 13)
        "core/dispatcher.zig",
        "core/lifecycle.zig",

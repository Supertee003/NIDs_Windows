//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite Phase 13)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! Phase 13 changes (on top of Phase 12):
//!   - Added Rust PEP to start()/shutdown() sequence.
//!   - PEP is initialized AFTER Policy (it executes Policy decisions).

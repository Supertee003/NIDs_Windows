...
// ============================================================
// Cross-platform invalid fd sentinel
// ============================================================
// On Linux/macOS, posix.fd_t is c_int (i32), invalid fd = -1.
// On Windows, posix.fd_t is windows.HANDLE (*anyopaque), invalid = INVALID_HANDLE_VALUE.
// Use INVALID_FD everywhere instead of literal -1 to stay cross-platform.

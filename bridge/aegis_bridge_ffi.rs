...
pub struct AegisIpcEvent {
    ...
    pub dest_ip:         c_uint,
    pub source_port:     c_ushort,  // u16 - matches C++ IpcEvent in C++ but c_uint for ABI alignment
    pub dest_port:       c_ushort,  // u16 - matches C++ IpcEvent
    pub protocol:        c_uchar,   // u8 - matches C++ IpcEvent in C++
    pub direction:       c_uchar,   // u8
    pub layer_id:        c_uchar,   // u8
    pub tier_result:     c_uchar,   // u8

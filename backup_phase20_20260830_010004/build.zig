...
pub fn build(b: *std.Build) void {
    ...
    // Rewrite Phase 20: Added release_engineering.zig + release_engineering_integration.zig.
    //
    ...
    //   core/release_engineering.zig -> std only (no deps)
    //   core/release_engineering_integration.zig -> release_engineering (exists)
    //

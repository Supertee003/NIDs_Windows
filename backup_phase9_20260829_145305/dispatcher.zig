//! runtime/dispatcher.zig - AEGIS Runtime Dispatcher (Rewrite Phase 8)
//!
...
pub fn processEvent(event: canonical.CanonicalEvent) void {
    ...
    // Phase 9+: correlation_int.submitEvidence(evidence_list, av)
    // Phase 12+: policy_int.evaluateAndEnforce(event, av)
    // Phase 14+: forensics_int.logPipelineResult(event, av)
}

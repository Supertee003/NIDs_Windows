//! lifecycle.zig - AEGIS Runtime Lifecycle (Rewrite Phase 18)
//!
//! Manages init/shutdown of all subsystems in correct order.
//! main() calls runtime.start() and runtime.shutdown() - nothing else.
//!
//! Phase 18 changes (on top of Phase 17):
//!   - Added IPS Canary to start()/shutdown() sequence.
//!   - Canary is a health monitoring tool (not a pipeline stage).

# AEGIS NIDS - Phase 32: Npcap Real Traffic Capture (v2)

**Risk**: MEDIUM | **Tier 3 - Core Capability Expansion** | **Status: FIELD-VERIFIED + v2**
...
| `core/npcap_test_live.zig` | Standalone live-capture verification CLI (v2: L2 classification printout) |
...
npcap_test_live.exe auto 50 "ip or arp"      # 3) 50 packets, hide wifi L2 chatter
npcap_test_live.exe auto 50 "tcp port 80"    # 4) 50 packets with BPF filter
npcap_test_live.exe 5 30                     # 5) explicit device index
```

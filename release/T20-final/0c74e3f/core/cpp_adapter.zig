// cpp_adapter.zig — Zig → C++ Adapter Framework ABI bridge (T2, Step 12)
//
...
// ============================================================
// C++ Adapter ABI — extern "C" declarations (from aegis_adapter.hpp)
// ============================================================
...
pub const CppAdapter = struct {
    ...
    pub const Handle = struct {
        ...
        /// frames (109 bytes each) into `wire_buf` (which must be ≥ 109*max_frames).
...
// Zig fabric (nose_contract.submitEvent).  Acquisition only —
// no policy / detection.
// ============================================================
